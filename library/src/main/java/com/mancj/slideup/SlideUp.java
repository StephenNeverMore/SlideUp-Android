...
public class SlideUp implements View.OnTouchListener, ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    ...
    public SlideUp(final View view) {
        ...
        Log.e("AA", "view相对屏幕的总距离：" + density);
        this.touchableTop = 300 * density;
        Log.e("AA", "当前的可触碰最高对。。：" + touchableTop);
        view.setOnTouchListener(this);
        view.setPivotY(0);
        createAnimation();
        //获得View  Tree的层级观察Listener
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        Log.e("AA", "当前触碰的getRawY" + event.getRawY());
        Log.e("AA", "当前触碰的getTop" + view.getTop());
        Log.e("AA", "可碰触区域" + touchedArea);
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                Log.e("AA", "当前视图中ACTION_DOWN    getTranslationY  :"+viewStartPositionY);
            ...
            case MotionEvent.ACTION_UP:
                ...
                Log.e("AA", "当前视图中ACTION_UP    getTranslationY  :"+slideAnimationFrom);
